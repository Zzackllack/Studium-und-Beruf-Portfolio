export const portfolioSections = [
  ...
  {
    title: "Vierter Abschnitt",
    content: "text",
  },
  {
    title: "Fünfter Abschnitt",
    content: "text",
    imageUrl:
